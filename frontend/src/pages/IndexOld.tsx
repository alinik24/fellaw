...
const Index = () => {
  ...
  const successStats = [
    { icon: CheckCircle, number: '15,000+', label: 'Cases Resolved' },
    { icon: Award, number: '98%', label: 'Success Rate' },
    { icon: DollarSign, number: '€2.3M', label: 'Costs Saved' },
    { icon: Clock, number: '48h', label: 'Avg. Response' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {isRegisteredUser ? (
          <>
            ...
            <div className="bg-white/20 backdrop-blur-md rounded-xl p-8 mb-12 shadow-lg text-left">
              ...
              <div className="space-y-6">
                ...
                {mockCases.length > 0 ? (
                  <div className="space-y-4">
                    {mockCases.map((case_) => (
                      <Card key={case_.id} className="bg-white/30 rounded-lg hover:bg-white/40 transition-colors">
                  ...
                  <Card className="bg-white/30 rounded-lg p-6 text-center">
          ...
          <>
            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center hover:scale-105 transition-transform">
              ...
              <h2 className="text-2xl mb-4 text-foreground">Your Legal Rights, Simplified</h2>

              <p className="text-xl text-muted-foreground mb-12">
                Join thousands who've discovered stress-free, affordable legal solutions.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
              {successStats.map((stat, index) => (
                <Card key={index} className="bg-white/30 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200 hover:shadow-xl transition-all">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  Join our network of legal professionals. Access cases, manage clients, and grow your practice.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild className="w-full" size="lg">
                  <Link to="/work-with-us/professionals">Access Dashboard</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200 hover:shadow-xl transition-all">
              <CardHeader>
                ...
                <CardTitle className="text-2xl">Careers at fellaw</CardTitle>
                <CardDescription className="text-base">
                  Join our mission to make legal services accessible. Explore opportunities in tech, legal ops, and more.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Button asChild className="w-full" size="lg" variant="outline">
                  <Link to="/work-with-us/careers">View Openings</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
        ...
        {/* Main Action Buttons - Same for both views */}
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  asChild
                  className="w-full h-32 text-xl font-bold bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white shadow-2xl border-4 border-red-300 hover:scale-105 transition-all duration-200 emergency-pulse"
                >
                  <Link to="/urgent/select" className="flex flex-col items-center justify-center">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  asChild
                  className="w-full h-32 text-xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white shadow-2xl hover:scale-105 transition-all duration-200"
                >
                  <Link to="/new-case" className="flex flex-col items-center justify-center">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {legalInsurancePartners.map((partner) => (
              <Card key={partner.name} className="bg-white/40 backdrop-blur-sm hover:bg-white/50 transition-colors shadow-lg">
                <CardHeader className="text-center">
                  <div className="w-full h-24 bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg mb-4 flex items-center justify-center overflow-hidden">
                    <img 
                      src={partner.logo} 
                      alt={partner.name}
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-white/40 backdrop-blur-sm rounded-xl p-6 shadow-lg">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {quickAccessCards.map((card, index) => (
              <Card key={index} className="bg-white/30 backdrop-blur-sm hover:bg-white/40 transition-colors cursor-pointer">
                <CardHeader>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Card className="bg-gradient-to-br from-purple-50 to-blue-50 border-purple-200 hover:shadow-lg transition-all cursor-pointer">
                  <CardHeader>
        ...
        <section className="text-center bg-white/20 backdrop-blur-md rounded-xl p-8">
